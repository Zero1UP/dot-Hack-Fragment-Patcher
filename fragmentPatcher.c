	...
	while(1)
	{
		...
		if(new_pad & PAD_START)
		{
			...
			*(u32*)0x8007A1C8 = 0x27BD0080;
			...
			//Code Stack
			*(u32*)0x8007A1CC = 0x002a87a8; //DNAS Bypass Address
			*(u32*)0x8007A1D0 = 0x24020001; //DNAS Bypass Data
			*(u32*)0x8007A1D4 = 0x005E03A0; //DNS Address 1
			*(u32*)0x8007A1D8 = 0x6F642E61; //DNS Data 1
			*(u32*)0x8007A1DC = 0x005E03A4; //DNS Address 2
			*(u32*)0x8007A1E0 = 0x63616874; //DNS Data 2
			*(u32*)0x8007A1E4 = 0x005E03A8; //DNS Address 3
			*(u32*)0x8007A1E8 = 0x7372656B; //DNS Data 3
			*(u32*)0x8007A1EC = 0x005E03AC; //DNS Address 4
			*(u32*)0x8007A1F0 = 0x67726F2E; //DNS Data 4
			*(u32*)0x8007A1F4 = 0x005E03B0; //DNS Address 5
